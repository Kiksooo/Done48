...
Внутренний MVP маркетплейса услуг: три кабинета (администратор, специалист, заказчик), заказы, отклики, портфолио, чат по заказу, демо-финансы (баланс, резерв, холд, выплаты), in-app уведомления.
...
| Специалист  | `executor@demo.local`    |
...
В базе появляются категории, два демо-заказа (опубликованный с открытыми откликами и заказ в работе у демо-специалиста), приветственное уведомление заказчику.
