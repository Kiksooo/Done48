    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          Заказчик и исполнитель могут открыть спор с карточки заказа. Статус заказа переходит в «Спор». Если вы
          ставите исход спора «В пользу заказчика», «В пользу исполнителя», «Частичное» или «Закрыт», заказ в статусе
