    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">
          Роль «Заказчик» / «Исполнитель» можно сменить, если нет незавершённых заказов и активных откликов в ожидании. Кабинет подстраивается по данным из базы при следующем открытии страницы. Блокировка отключает вход. Удаление необратимо: снимаются заказы, где пользователь заказчик, и отклики исполнителя; с email снимается запись в блок-листе (если была), чтобы можно было зарегистрироваться снова. Навсегда запретить адрес: после удаления снова добавьте email в «Модерация» → блок-лист. Учётки администраторов не меняем и не удаляем.
        </p>
      </div>
