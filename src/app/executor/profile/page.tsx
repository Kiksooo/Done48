  ...
  return (
    <div className="space-y-6">
      <CabinetPageHeader
        ...
        description="Публичные поля профиля и контакты. Отклики на заказы доступны при статусе «Активен» (обычно сразу после регистрации). При необходимости администратор может изменить статус в разделе «Специалисты»."
      />
      {profile.username ? (
