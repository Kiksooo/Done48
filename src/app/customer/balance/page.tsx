  ...
  return (
    <div className="space-y-8">
      <CabinetPageHeader
        ...
        description="Пополнение баланса и вывод средств. Безопасная сделка: сумма резервируется под заказ до приёмки работы по правилам платформы. Ниже — история операций."
      />
