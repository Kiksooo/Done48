...
const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  ORDER_ASSIGN_EXECUTOR: "Назначение специалиста администратором",
  ORDER_ADMIN_UNASSIGN_EXECUTOR: "Снятие специалиста администратором",
  ORDER_SET_STATUS: "Смена статуса заказа",
  ORDER_ACCEPT_PROPOSAL: "Принят отклик (админ)",
  ORDER_CUSTOMER_ACCEPT_PROPOSAL: "Специалист выбран заказчиком",
  ORDER_CUSTOMER_UNASSIGN_EXECUTOR: "Снятие специалиста заказчиком",
  ORDER_CUSTOMER_COMPLETE: "Заказ закрыт заказчиком",
  ORDER_DELETE_CUSTOMER: "Удаление заказа заказчиком",
  ORDER_DELETE_ADMIN: "Удаление заказа администратором",
  ORDER_EXECUTOR_COMPLETE: "Заказ закрыт специалистом",
  PLATFORM_SETTINGS_UPDATE: "Обновление настроек платформы",
  USER_DELETE: "Удаление пользователя",
  EXECUTOR_ACCOUNT_STATUS_SET: "Статус анкеты специалиста",
...
const AUDIT_ENTITY_LABELS: Record<string, string> = {
  Order: "Заказ",
  Feedback: "Обращение",
  ExecutorProfile: "Профиль специалиста",
  User: "Пользователь",
